...
(function(){
  ...
  function injectStyles(){
    ...
    var css = ''
      ...
      + '#vn-signup-modal .vn-onboarding-note{background:#eff6ff;border-left:3px solid #3b82f6;'
      + '  color:#1e40af;font-size:12px;line-height:1.5;padding:10px 12px;border-radius:6px;margin:14px 0 4px;}'
      + '#vn-signup-modal .vn-onboarding-note strong{color:#1e3a8a;}'
